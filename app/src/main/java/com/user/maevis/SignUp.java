...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createAccount() {
        ...
        //final UserInformation userInformation = new UserInformation(email, username, password);
        final UserInformation userInformation = new UserInformation(username, password, email, firstName, lastName, birthdate, address);
    ...
    public void storeData(UserInformation userInformation) {

        DatabaseReference newUser = FirebaseUsers.child(userInformation.getUsername());
        newUser.setValue(true);
        newUser.child("Username").setValue(userInformation.getUsername());
        newUser.child("Password").setValue(userInformation.getPassword());
        newUser.child("Email Address").setValue(userInformation.getEmail());
        newUser.child("First Name").setValue(userInformation.getFirstName());
        newUser.child("Last Name").setValue(userInformation.getLastName());
        newUser.child("Birthdate").setValue(userInformation.getBirthdate());
        newUser.child("Address").setValue(userInformation.getAddress());
    }
}
